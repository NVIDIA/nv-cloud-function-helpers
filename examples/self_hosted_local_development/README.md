...
Follow the [Local Development guide](https://cloud-functions-tme.gitlab-master-pages.nvidia.com/documentation/current/latest/local-development.html) in the self-hosted documentation. It walks through:
