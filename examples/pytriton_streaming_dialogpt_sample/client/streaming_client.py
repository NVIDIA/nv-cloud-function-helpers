...
_LOGGER = logging.getLogger("huggingface_dialogpt_pytorch_streaming.client")


# TODO make this for NVCF and gradio based
...
def main():
    ...
    parser.add_argument("--model-name", default="DialoGPT", help="Name of the model", required=False)
    parser.add_argument(
        "--init-timeout-s",
        type=float,
        default=600.0,
